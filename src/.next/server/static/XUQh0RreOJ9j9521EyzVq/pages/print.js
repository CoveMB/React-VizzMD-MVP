...
module.exports = __webpack_require__("LhwD");
...
// CONCATENATED MODULE: ./components/Date.jsx
var __jsx = external_react_default.a.createElement;



class Date_Date extends external_react_["PureComponent"] {
  render() {
    const dateToFormat = new Date_Date();
    return __jsx("h2", {
...
/* harmony default export */ var components_Date = (Date_Date);
...
// EXTERNAL MODULE: external "@typeform/embed"
var embed_ = __webpack_require__("iQVn");

// EXTERNAL MODULE: external "next/router"
var router_ = __webpack_require__("4Q3z");
var router_default = /*#__PURE__*/__webpack_require__.n(router_);

// CONCATENATED MODULE: ./components/HomeBtn.jsx
var HomeBtn_jsx = external_react_default.a.createElement;
...
const HomeBtn = () => {
  ...
  return HomeBtn_jsx("div", {
    className: "reset"
  }, HomeBtn_jsx("button", {
    className: "btn btn-danger",
    onClick: goHome
  }, "Back ", HomeBtn_jsx(react_fontawesome_["FontAwesomeIcon"], {
    icon: free_solid_svg_icons_["faArrowCircleLeft"]
  })));
};

/* harmony default export */ var components_HomeBtn = (HomeBtn);
// CONCATENATED MODULE: ./components/BrandWhite.jsx
var BrandWhite_jsx = external_react_default.a.createElement;
 // import logo from '../../static/logo_white.png';

const BrandWhite = () => {
  return BrandWhite_jsx("div", {
    className: "brand"
  }, BrandWhite_jsx("img", {
...
/* harmony default export */ var components_BrandWhite = (BrandWhite);
// CONCATENATED MODULE: ./containers/printElements/PrintPopUp.jsx
var PrintPopUp_jsx = external_react_default.a.createElement;
...
const handleReview = event => {
  ...
  const popUp = embed_["makePopup"]('https://vizz.typeform.com/to/IhOm3d', {
    mode: 'popup',
    autoClose: 3000,
    hideHeaders: true,
    hideFooters: true,
...
const PrintPopUp = () => {
  return PrintPopUp_jsx("div", {
    id: "not-to-be-printed"
  }, PrintPopUp_jsx(external_reactjs_popup_default.a, {
    modal: true,
    position: "right center",
    open: true,
    onClose: backHome
  }, PrintPopUp_jsx(external_react_["Fragment"], null, PrintPopUp_jsx("div", {
    className: "gradient-square"
  }, PrintPopUp_jsx("h5", {
    className: "gradient-square-text"
  }, "Thanks for using"), PrintPopUp_jsx(components_BrandWhite, null)), PrintPopUp_jsx("h2", {
    className: "print-pop-up-text"
  }, "Printing..."), PrintPopUp_jsx("div", {
    className: "print-pop-up-btns"
  }, PrintPopUp_jsx(components_HomeBtn, null), PrintPopUp_jsx("button", {
    onClick: handleReview,
    className: "btn btn-secondary btn-pop-up-review",
    type: "submit"
  }, "Tell us what you think ", PrintPopUp_jsx(react_fontawesome_["FontAwesomeIcon"], {
    icon: free_solid_svg_icons_["faComment"]
  }))))));
};

/* harmony default export */ var printElements_PrintPopUp = (PrintPopUp);
// CONCATENATED MODULE: ./containers/printElements/ComponentToPrint.jsx
var ComponentToPrint_jsx = external_react_default.a.createElement;
...
class ComponentToPrint_ComponentToPrint extends external_react_["Component"] {
  componentDidMount() {
    window.print();
  }

  render() {
    return ComponentToPrint_jsx(external_react_["Fragment"], null, ComponentToPrint_jsx(printElements_PrintPopUp, null), ComponentToPrint_jsx("div", {
      id: "printComponent"
    }, ComponentToPrint_jsx("div", {
      className: "print-container print-brand-section"
    }, ComponentToPrint_jsx("div", {
      className: "print-item"
    }, ComponentToPrint_jsx(Brand["a" /* default */], null)), ComponentToPrint_jsx("div", {
      className: "print-item"
    }, ComponentToPrint_jsx("div", {
      className: "print-info"
    }, ComponentToPrint_jsx(components_Date, null), ComponentToPrint_jsx(PatientRef["a" /* default */], null)))), ComponentToPrint_jsx("div", {
      className: "print-container"
    }, ComponentToPrint_jsx("div", {
      className: "print-body-part"
    }, ComponentToPrint_jsx(FaceBody["a" /* default */], {
    ...
    }, ComponentToPrint_jsx(MusclesTable["a" /* default */], null)), ComponentToPrint_jsx("div", {
      className: "print-body-part"
    }, ComponentToPrint_jsx(FaceBody["a" /* default */], {
...
/* harmony default export */ var printElements_ComponentToPrint = (ComponentToPrint_ComponentToPrint);
// CONCATENATED MODULE: ./pages/print/index.jsx
var print_jsx = external_react_default.a.createElement;




const printPage = () => {
  return print_jsx(printElements_ComponentToPrint, null);
};

/* harmony default export */ var print = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(state => state)(printPage));
